...
public class TBAMatchKeysJSONRequest extends JsonArrayRequest {

    public TBAMatchKeysJSONRequest(int method, String url, JSONArray jsonRequest, Response.Listener<JSONArray> listener, Response.ErrorListener eListener) {
